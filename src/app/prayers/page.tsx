...
const prayerCardColors: Record<Prayer, string> = {
    fajr: "bg-blue-900/80 hover:bg-blue-900/90 border-blue-700/80",
    dhuhr: "bg-yellow-800/80 hover:bg-yellow-800/90 border-yellow-600/80",
    asr: "bg-orange-800/80 hover:bg-orange-800/90 border-orange-600/80",
    maghrib: "bg-rose-900/80 hover:bg-rose-900/90 border-rose-700/80",
