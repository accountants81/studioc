...
import { PlusCircle, Trash2, Edit, Save, X, Lightbulb } from "lucide-react";
...
const translations = {
  ar: {
    pageTitle: "أفكاري المجنونة",
    addNote: "إضافة فكرة",
    newNoteTitle: "فكرة جديدة",
    newNoteDesc: "اكتب عنوان وتفاصيل فكرتك الجديدة.",
    noteTitlePlaceholder: "عنوان الفكرة",
    noteContentPlaceholder: "صف فكرتك هنا...",
    cancel: "إلغاء",
    saveNote: "حفظ الفكرة",
    noNotes: "لا توجد أفكار مجنونة بعد",
    noNotesDesc: "أطلق العنان لإبداعك! دوّن أول فكرة.",
    save: "حفظ",
    deleteConfirm: "هل أنت متأكد؟",
    deleteDesc: "سيتم حذف هذه الفكرة نهائيًا.",
    delete: "حذف",
    noContent: "لا يوجد محتوى.",
  },
  en: {
    pageTitle: "My Crazy Ideas",
    addNote: "Add Idea",
    newNoteTitle: "New Idea",
    newNoteDesc: "Write the title and details for your new idea.",
    noteTitlePlaceholder: "Idea Title",
    noteContentPlaceholder: "Describe your idea here...",
    cancel: "Cancel",
    saveNote: "Save Idea",
    noNotes: "No crazy ideas yet",
    noNotesDesc: "Unleash your creativity! Write down your first idea.",
    save: "Save",
    deleteConfirm: "Are you sure?",
    deleteDesc: "This idea will be permanently deleted.",
    delete: "Delete",
...
export default function IdeasPage() {
  const [notes, setNotes] = useLocalStorage<Note[]>("timeflow-ideas", []);
