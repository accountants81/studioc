...
import { PlusCircle, Trash2, Edit, Save, X, Shield } from "lucide-react";
...
const translations = {
  ar: {
    ...
    noNotesDesc: "ابدأ بإضافة ملاحظتك الأولى في الخزنة.",
    save: "حفظ",
  ...
  en: {
    ...
    noNotesDesc: "Start by adding your first note in the vault.",
    save: "Save",
...
export default function VaultPage() {
  const [notes, setNotes] = useLocalStorage<Note[]>("timeflow-vault", []);
