...
import { PlusCircle, Trash2, Edit, Save, X, Trophy } from "lucide-react";
...
const translations = {
  ar: {
    pageTitle: "التحديات",
    addNote: "إضافة تحدي",
    newNoteTitle: "تحدي جديد",
    newNoteDesc: "اكتب عنوان ومحتوى تحديك الجديد.",
    noteTitlePlaceholder: "عنوان التحدي",
    noteContentPlaceholder: "اكتب تفاصيل التحدي هنا...",
    cancel: "إلغاء",
    saveNote: "حفظ التحدي",
    noNotes: "لا توجد تحديات بعد",
    noNotesDesc: "ابدأ بإضافة تحديك الأول.",
    save: "حفظ",
    deleteConfirm: "هل أنت متأكد؟",
    deleteDesc: "سيتم حذف هذا التحدي نهائيًا.",
    delete: "حذف",
    noContent: "لا يوجد محتوى.",
  },
  en: {
    pageTitle: "Challenges",
    addNote: "Add Challenge",
    newNoteTitle: "New Challenge",
    newNoteDesc: "Write the title and content for your new challenge.",
    noteTitlePlaceholder: "Challenge Title",
    noteContentPlaceholder: "Write your thoughts here...",
    cancel: "Cancel",
    saveNote: "Save Challenge",
    noNotes: "No challenges yet",
    noNotesDesc: "Start by adding your first challenge.",
    save: "Save",
    deleteConfirm: "Are you sure?",
    deleteDesc: "This challenge will be permanently deleted.",
    delete: "Delete",
...
export default function ChallengesPage() {
  const [notes, setNotes] = useLocalStorage<Note[]>("timeflow-challenges", []);
