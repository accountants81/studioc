...
import { PlusCircle, Trash2, Edit, Save, X, Cloud } from "lucide-react";
...
const translations = {
  ar: {
    pageTitle: "أحلامي",
    addNote: "إضافة حلم",
    newNoteTitle: "حلم جديد",
    newNoteDesc: "اكتب عنوان وتفاصيل حلمك الجديد.",
    noteTitlePlaceholder: "عنوان الحلم",
    noteContentPlaceholder: "صف حلمك هنا...",
    cancel: "إلغاء",
    saveNote: "حفظ الحلم",
    noNotes: "لا توجد أحلام بعد",
    noNotesDesc: "ما هو حلمك الكبير القادم؟ ابدأ بتدوينه الآن!",
    save: "حفظ",
    deleteConfirm: "هل أنت متأكد؟",
    deleteDesc: "سيتم حذف هذا الحلم نهائيًا.",
    delete: "حذف",
  ...
  en: {
    pageTitle: "My Dreams",
    addNote: "Add Dream",
    newNoteTitle: "New Dream",
    newNoteDesc: "Write the title and details for your new dream.",
    noteTitlePlaceholder: "Dream Title",
    noteContentPlaceholder: "Describe your dream here...",
    cancel: "Cancel",
    saveNote: "Save Dream",
    noNotes: "No dreams yet",
    noNotesDesc: "What's your next big dream? Start by writing it down!",
    save: "Save",
    deleteConfirm: "Are you sure?",
    deleteDesc: "This dream will be permanently deleted.",
    delete: "Delete",
...
export default function DreamsPage() {
  const [notes, setNotes] = useLocalStorage<Note[]>("timeflow-dreams", []);
