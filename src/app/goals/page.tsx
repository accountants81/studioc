...
import { PlusCircle, Trash2, Edit, Save, X, Target } from "lucide-react";
...
const translations = {
  ar: {
    pageTitle: "الأهداف",
    addNote: "إضافة هدف",
    newNoteTitle: "هدف جديد",
    newNoteDesc: "اكتب عنوان ومحتوى هدفك الجديد.",
    noteTitlePlaceholder: "عنوان الهدف",
    noteContentPlaceholder: "اكتب تفاصيل الهدف هنا...",
    cancel: "إلغاء",
    saveNote: "حفظ الهدف",
    noNotes: "لا توجد أهداف بعد",
    noNotesDesc: "ابدأ بإضافة هدفك الأول.",
    save: "حفظ",
    deleteConfirm: "هل أنت متأكد؟",
    deleteDesc: "سيتم حذف هذا الهدف نهائيًا.",
    delete: "حذف",
  ...
  en: {
    pageTitle: "Goals",
    addNote: "Add Goal",
    newNoteTitle: "New Goal",
    newNoteDesc: "Write the title and content for your new goal.",
    noteTitlePlaceholder: "Goal Title",
    noteContentPlaceholder: "Write your thoughts here...",
    cancel: "Cancel",
    saveNote: "Save Goal",
    noNotes: "No goals yet",
    noNotesDesc: "Start by adding your first goal.",
    save: "Save",
...
export default function GoalsPage() {
  const [notes, setNotes] = useLocalStorage<Note[]>("timeflow-goals", []);
